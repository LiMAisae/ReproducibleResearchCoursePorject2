...
After converting the variable **EVTYPE** to uppercase, there are still `r dim(table(StormData$EVTYPE))` different event types listed. According to the NOAA there should be only 48. So there are a lot of duplicates. 
